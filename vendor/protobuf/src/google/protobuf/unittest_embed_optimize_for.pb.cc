...
descriptor_table_google_2fprotobuf_2funittest_5fembed_5foptimize_5ffor_2eproto_metadata_getter(int index) {
  ...
  return descriptor_table_google_2fprotobuf_2funittest_5fembed_5foptimize_5ffor_2eproto.file_level_metadata[index];
}
