...
descriptor_table_google_2fprotobuf_2fmap_5funittest_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_google_2fprotobuf_2fmap_5funittest_2eproto);
  return descriptor_table_google_2fprotobuf_2fmap_5funittest_2eproto.file_level_metadata[index];
}
