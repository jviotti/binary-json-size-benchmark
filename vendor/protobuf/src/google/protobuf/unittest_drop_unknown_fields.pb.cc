...
descriptor_table_google_2fprotobuf_2funittest_5fdrop_5funknown_5ffields_2eproto_metadata_getter(int index) {
  ...
  return descriptor_table_google_2fprotobuf_2funittest_5fdrop_5funknown_5ffields_2eproto.file_level_metadata[index];
}
