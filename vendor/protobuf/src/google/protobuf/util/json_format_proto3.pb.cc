...
descriptor_table_google_2fprotobuf_2futil_2fjson_5fformat_5fproto3_2eproto_metadata_getter(int index) {
  ...
  return descriptor_table_google_2fprotobuf_2futil_2fjson_5fformat_5fproto3_2eproto.file_level_metadata[index];
}
