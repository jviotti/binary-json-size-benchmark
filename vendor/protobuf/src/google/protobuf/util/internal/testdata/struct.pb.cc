...
descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2fstruct_2eproto_metadata_getter(int index) {
  ...
  return descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2fstruct_2eproto.file_level_metadata[index];
}
