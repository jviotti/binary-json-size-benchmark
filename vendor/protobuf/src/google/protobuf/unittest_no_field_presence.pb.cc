...
descriptor_table_google_2fprotobuf_2funittest_5fno_5ffield_5fpresence_2eproto_metadata_getter(int index) {
  ...
  return descriptor_table_google_2fprotobuf_2funittest_5fno_5ffield_5fpresence_2eproto.file_level_metadata[index];
}
