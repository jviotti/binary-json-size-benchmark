...
descriptor_table_google_2fprotobuf_2funittest_5fmset_5fwire_5fformat_2eproto_metadata_getter(int index) {
  ...
  return descriptor_table_google_2fprotobuf_2funittest_5fmset_5fwire_5fformat_2eproto.file_level_metadata[index];
}
