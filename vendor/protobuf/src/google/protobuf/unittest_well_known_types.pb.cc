...
descriptor_table_google_2fprotobuf_2funittest_5fwell_5fknown_5ftypes_2eproto_metadata_getter(int index) {
  ...
  return descriptor_table_google_2fprotobuf_2funittest_5fwell_5fknown_5ftypes_2eproto.file_level_metadata[index];
}
