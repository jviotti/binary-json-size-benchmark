...
descriptor_table_google_2fprotobuf_2funittest_5fproto3_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_google_2fprotobuf_2funittest_5fproto3_2eproto);
  return descriptor_table_google_2fprotobuf_2funittest_5fproto3_2eproto.file_level_metadata[index];
}
