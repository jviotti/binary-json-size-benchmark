...
tap.test('should encode [] (1:3) as 00', (test) => {
...
tap.test('should encode [ 1, 2, 3 ] (1:3) as REVERSE(00 01 10 00)', (test) => {
  ...
  test.strictSame(buffer.getBuffer(), Buffer.from([ 0x03, 0b00011000 ]))
...
tap.test('should encode [ 1, 2, 3, 2 ] (1:3) as REVERSE(00 01 10 01)', (test) => {
  ...
  test.strictSame(buffer.getBuffer(), Buffer.from([ 0x04, 0b10011000 ]))
  test.is(bytesWritten, 2)
  test.end()
})
...
tap.test('should encode [ 1, 2, 3, 2, 2 ] (1:3) as REVERSE(00 01 10 01) ++ REVERSE(01 000000)', (test) => {
  ...
  test.strictSame(buffer.getBuffer(), Buffer.from([ 0x05, 0b10011000, 0b00000010 ]))
...
tap.test('should encode [ 1, 2, 3, 2, 2, 3 ] (1:3) as REVERSE(00 01 10 01) ++ REVERSE(01 10 0000)', (test) => {
  ...
  test.strictSame(buffer.getBuffer(), Buffer.from([ 0x06, 0b10011000, 0b00000110 ]))
  test.is(bytesWritten, 3)
  test.end()
})
...
tap.test('should encode [ 5, 6, 6, 5 ] (5:6) as REVERSE(0110 0000)', (test) => {
  ...
  test.strictSame(buffer.getBuffer(), Buffer.from([ 0x04, 0b00000110 ]))
  test.is(bytesWritten, 2)
  test.end()
})
...
tap.test('should encode [ 1, 2 ] (0:3) as REVERSE(01 10 0000)', (test) => {
  ...
  test.strictSame(buffer.getBuffer(), Buffer.from([ 0x02, 0b00000110 ]))
  test.is(bytesWritten, 2)
  test.end()
})
...
tap.test('should encode [ 1, 2 ] (0:4) as REVERSE(001 010 00)', (test) => {
  ...
  test.strictSame(buffer.getBuffer(), Buffer.from([ 0x02, 0b00010100 ]))
  test.is(bytesWritten, 2)
  test.end()
})
...
tap.test('should encode [ 1, 2, 3 ] (0:4) as REVERSE(001 010 01) ++ REVERSE(1 0000000)', (test) => {
  ...
  test.strictSame(buffer.getBuffer(), Buffer.from([ 0x03, 0b10010100, 0b00000001 ]))
  test.is(bytesWritten, 3)
  test.end()
})
...
tap.test('should encode [ 1, 2, 3, 4 ] (0:4) as REVERSE(001 010 01) ++ REVERSE(1 100 0000)', (test) => {
  ...
  test.strictSame(buffer.getBuffer(), Buffer.from([ 0x04, 0b10010100, 0b00000011 ]))
  test.is(bytesWritten, 3)
  test.end()
})
...
tap.test('should encode [ 3, 2 ] (0:127) as REVERSE(0000011 0) ++ REVERSE(000010 00)', (test) => {
  ...
  test.strictSame(buffer.getBuffer(), Buffer.from([ 0x02, 0b01100000, 0b00010000 ]))
  test.is(bytesWritten, 3)
  test.end()
})
...
tap.test('should encode/decode [ 1, 2, 3 ] (1:3)', (test) => {
  ...
  const result: IntegerListResult = integerListDecode(buffer, offset, {
    minimum: 1,
    maximum: 3
  })
