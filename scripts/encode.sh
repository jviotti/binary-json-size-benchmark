...
if [ "$FORMAT" = "avro" ] || [ "$FORMAT" = "bson" ] || [ "$FORMAT" = "capnproto" ] || [ "$FORMAT" = "cbor" ] || [ "$FORMAT" = "flatbuffers" ] || [ "$FORMAT" = "flexbuffers" ] || [ "$FORMAT" = "json" ] || [ "$FORMAT" = "smile" ] || [ "$FORMAT" = "ubjson" ] || [ "$FORMAT" = "messagepack" ]
then
