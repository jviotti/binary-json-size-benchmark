...
namespace bond
{
    ...
    extern template 
    bool Apply(const ::bond::To< ::benchmark::Rule>& transform,
               const ::bond::bonded< ::benchmark::Rule>& value);

    extern template 
    bool Apply(const ::bond::InitSchemaDef& transform,
               const ::benchmark::Rule& value);

    extern template 
    bool Apply(const ::bond::Null& transform,
               const ::bond::bonded< ::benchmark::Rule, ::bond::SimpleBinaryReader< ::bond::InputBuffer>&>& value);
    
    extern template 
    bool Apply(const ::bond::To< ::benchmark::Rule>& transform,
               const ::bond::bonded< ::benchmark::Rule,  ::bond::CompactBinaryReader<::bond::InputBuffer>&>& value);
    ...
    extern template 
    bool Apply(const ::bond::Serializer< ::bond::CompactBinaryWriter<::bond::OutputBuffer> >& transform,
               const ::bond::bonded< ::benchmark::Rule,  ::bond::FastBinaryReader<::bond::InputBuffer>&>& value);
