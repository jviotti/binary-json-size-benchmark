...
namespace benchmark
{
    ...
    struct Rules::Schema
    {
        ...
        private: static const ::bond::Metadata s_noAny_metadata;
        private: static const ::bond::Metadata s_radix_metadata;
        private: static const ::bond::Metadata s_orderedImports_metadata;

        public: struct var
        {
            // noAny
            typedef struct noAny_type : ::bond::reflection::FieldTemplate<
                0,
                ::bond::reflection::required_field_modifier,
                Rules,
                std::list<bool>,
            ...
            // radix
            typedef struct radix_type : ::bond::reflection::FieldTemplate<
                1,
                ::bond::reflection::required_field_modifier,
                Rules,
                std::list<bool>,
        ...
        private: typedef boost::mpl::push_front<fields1, var::radix>::type fields2;
        private: typedef boost::mpl::push_front<fields2, var::noAny>::type fields3;
