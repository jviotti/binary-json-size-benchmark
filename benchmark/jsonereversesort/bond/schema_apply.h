...
namespace bond
{
    ...
    extern template 
    bool Apply(const ::bond::To< ::benchmark::Let>& transform,
               const ::bond::bonded< ::benchmark::Let>& value);

    extern template 
    bool Apply(const ::bond::InitSchemaDef& transform,
               const ::benchmark::Let& value);

    extern template 
    bool Apply(const ::bond::Null& transform,
               const ::bond::bonded< ::benchmark::Let, ::bond::SimpleBinaryReader< ::bond::InputBuffer>&>& value);
    
    extern template 
    bool Apply(const ::bond::To< ::benchmark::Let>& transform,
               const ::bond::bonded< ::benchmark::Let,  ::bond::CompactBinaryReader<::bond::InputBuffer>&>& value);
    ...
    extern template 
    bool Apply(const ::bond::Serializer< ::bond::CompactBinaryWriter<::bond::OutputBuffer> >& transform,
               const ::bond::bonded< ::benchmark::Let,  ::bond::FastBinaryReader<::bond::InputBuffer>&>& value);
    ...
    extern template 
    bool Apply(const ::bond::To< ::benchmark::Sort>& transform,
               const ::bond::bonded< ::benchmark::Sort>& value);

    extern template 
    bool Apply(const ::bond::InitSchemaDef& transform,
               const ::benchmark::Sort& value);

    extern template 
    bool Apply(const ::bond::Null& transform,
               const ::bond::bonded< ::benchmark::Sort, ::bond::SimpleBinaryReader< ::bond::InputBuffer>&>& value);
    
    extern template 
    bool Apply(const ::bond::To< ::benchmark::Sort>& transform,
               const ::bond::bonded< ::benchmark::Sort,  ::bond::CompactBinaryReader<::bond::InputBuffer>&>& value);
    ...
    extern template 
    bool Apply(const ::bond::Serializer< ::bond::CompactBinaryWriter<::bond::OutputBuffer> >& transform,
               const ::bond::bonded< ::benchmark::Sort,  ::bond::FastBinaryReader<::bond::InputBuffer>&>& value);
    ...
    //
    // Extern template specializations of Apply function with common
    // transforms for Reverse.
    //

    extern template 
    bool Apply(const ::bond::To< ::benchmark::Reverse>& transform,
               const ::bond::bonded< ::benchmark::Reverse>& value);

    extern template 
    bool Apply(const ::bond::InitSchemaDef& transform,
               const ::benchmark::Reverse& value);

    extern template 
    bool Apply(const ::bond::Null& transform,
               const ::bond::bonded< ::benchmark::Reverse, ::bond::SimpleBinaryReader< ::bond::InputBuffer>&>& value);
    
    extern template 
    bool Apply(const ::bond::To< ::benchmark::Reverse>& transform,
               const ::bond::bonded< ::benchmark::Reverse,  ::bond::CompactBinaryReader<::bond::InputBuffer>&>& value);
    ...
    extern template 
    bool Apply(const ::bond::Serializer< ::bond::CompactBinaryWriter<::bond::OutputBuffer> >& transform,
               const ::bond::bonded< ::benchmark::Reverse,  ::bond::FastBinaryReader<::bond::InputBuffer>&>& value);
    ...
    extern template 
    bool Apply(const ::bond::To< ::benchmark::In>& transform,
               const ::bond::bonded< ::benchmark::In>& value);

    extern template 
    bool Apply(const ::bond::InitSchemaDef& transform,
               const ::benchmark::In& value);

    extern template 
    bool Apply(const ::bond::Null& transform,
               const ::bond::bonded< ::benchmark::In, ::bond::SimpleBinaryReader< ::bond::InputBuffer>&>& value);
    
    extern template 
    bool Apply(const ::bond::To< ::benchmark::In>& transform,
               const ::bond::bonded< ::benchmark::In,  ::bond::CompactBinaryReader<::bond::InputBuffer>&>& value);
    ...
    extern template 
    bool Apply(const ::bond::Serializer< ::bond::CompactBinaryWriter<::bond::OutputBuffer> >& transform,
               const ::bond::bonded< ::benchmark::In,  ::bond::FastBinaryReader<::bond::InputBuffer>&>& value);
